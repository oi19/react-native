# Tracker Project:
  ...
  - This App is blog-like app where you can write blogs(posts) , edit , delete , show details of them adding the flexablitiy for future improvements and new features
